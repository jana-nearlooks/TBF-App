                ...
                <div class="row g-0">
                    <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
                            <div class="card-body">
                                <img src="../assets/images/login_img.png" class="img-fluid auth-img-cover-login" width="700" alt=""/>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-sm-5">
                                <div class="">
                                    <div class="mb-3 text-center">
                                        <img src="../assets/images/logo-light.png" width="300" alt="">
                                    </div>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="post" action="">
                                            <div class="col-12">
                                                ...
                                                <input type="email" class="form-control" id="inputEmailAddress" placeholder="john@example.com" name="email">
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="text-center mt-2 ">
                                                    <p class="mb-0">Back to home? <a href="index.html">Click here</a></p>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
